...
const translations = {
  ...
  ru: {
    common: {
      ...
      soldOut: 'Распродано',
      ticketsLeft: ({ count }: Record<string, string | number> = {}) => `${count} билетов осталось`,
      ...
      searchMarketplace: 'Поиск событий, стилей, площадок...',
  ...
  kk: {
    common: {
      ...
      ticketsLeft: ({ count }: Record<string, string | number> = {}) => `${count} билет қалды`,
      ...
      searchMarketplace: 'Іс-шара, стиль, алаң іздеу...',
