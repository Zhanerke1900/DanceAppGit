...
const copy = {
  en: {
    ...
    presentQr: "Present this QR code at the entrance. It covers all tickets in this purchase.",
  ...
  ru: {
    ...
    presentQr: "Покажите этот QR-код на входе. Он действует на все билеты в этой покупке.",
  ...
  kk: {
    ...
    presentQr: "Кіреберісте осы QR-кодты көрсетіңіз. Ол осы сатып алудағы барлық билеттерге жарайды.",
